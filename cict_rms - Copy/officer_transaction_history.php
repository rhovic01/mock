                    ...
                    <?php else: ?>
                        <?php foreach ($transactions as $transaction): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill bg-<?php echo $transaction['transaction_type'] === 'checkout' ? 'primary' : 'success'; ?> bg-opacity-10 text-<?php echo $transaction['transaction_type'] === 'checkout' ? 'primary' : 'success'; ?>">
